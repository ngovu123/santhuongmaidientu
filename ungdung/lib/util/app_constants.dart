...
class AppConstants {
  static const String appName = 'GoFast';
  static const double appVersion = 2.5;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://gofastuser.tdmuchatgpt.id.vn';

  static const String baseUrl = 'https://gofast.tdmuchatgpt.id.vn';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.vietnam, languageName: 'VIET NAM', countryCode: 'VN', languageCode: 'vi'),
